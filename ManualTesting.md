...
| 18 | TC_RD_018 | Responsive Design - Tablet View (768px) | 1. Open Chrome DevTools<br>2. Set viewport to 768x1024 (iPad)<br>3. Navigate to Application Form<br>4. Check layout and usability | Form should adapt to tablet size. Layout should be clean and usable | Form adapts well to tablet view. Good spacing. All elements accessible | ✅ PASS | Medium | P2 | ![Tablet View](screenshots/Manual_Testing/TC_RD_002_Tablet_View.png) |
| 19 | TC_NAV_019 | Main Navigation Menu - All Menu Items | 1. Open homepage<br>2. Click on each menu item (Overview, Curriculum, Placements, Admissions, Application Form)<br>3. Verify pages load correctly | All navigation links should work correctly and load respective pages | ✅ PASSED: All navigation menu items work correctly. Pages load without errors | ✅ PASS | High | P1 | ![Navigation 1](screenshots/Manual_Testing/Screenshot_8.png)<br>![Navigation 2](screenshots/Manual_Testing/Screenshot_9.png)<br>![Navigation 3](screenshots/Manual_Testing/Screenshot_10.png)<br>![Navigation 4](screenshots/Manual_Testing/Screenshot_11.png) |
| 20 | TC_FL_020 | Footer Links Verification | 1. Scroll to page footer<br>2. Click all footer links (social media, contact, about, etc.)<br>3. Verify they open correctly | All footer links should be valid and work correctly. Social media links should open in new tabs | ✅ PASSED: All footer links work correctly. Social media links open in new tabs as expected | ✅ PASS | Medium | P2 | ![Footer 1](screenshots/Manual_Testing/Screenshot_12.png)<br>![Footer 2](screenshots/Manual_Testing/Screenshot_13.png)<br>![Footer 3](screenshots/Manual_Testing/Screenshot_14.png)<br>![Footer 4](screenshots/Manual_Testing/Screenshot_15.png)<br>![Footer 5](screenshots/Manual_Testing/Screenshot_16.png) |
