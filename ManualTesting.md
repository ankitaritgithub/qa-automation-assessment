...
| 8 | TC_NAV_008 | Application Form Tab Navigation | 1. On PGP page<br>2. Click "Application Form" tab from menu (Overview, Curriculum, Placements, Admissions, Application Form)<br>3. Verify application form section displays | Should scroll to or display application form section with input fields | Application form section displayed with fields: Full Name, Email Address, Mobile Number, and "Start My Application" button | ✅ PASS | Medium | P2 | ![Application Form Tab](screenshots/Manual_Testing/Screenshot_13.png)<br>![Application Form Tab](screenshots/Manual_Testing/Screenshot_17.png)<br>![Application Form Tab](screenshots/Manual_Testing/Screenshot_18.png)<br>![Application Form Tab](screenshots/Manual_Testing/Screenshot_19.png)<br>![Application Form Tab](screenshots/Manual_Testing/Screenshot_20.png) |
...
| 18 | TC_RD_018 | Responsive Design - Tablet View (768px) | 1. Open Chrome DevTools<br>2. Set viewport to 768x1024 (iPad)<br>3. Navigate to Application Form<br>4. Check layout and usability | Form should adapt to tablet size. Layout should be clean and usable | Form adapts well to tablet view. Good spacing. All elements accessible | ✅ PASS | Medium | P2 | ![Tablet View](screenshots/Manual_Testing/Screenshot_20.png) |
